---
url: /api/specs/schema/types/fn/oas/function-generate-spec.md
...
> See [/packages/specs/schema/src/fn/oas/generateSpec.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/fn/oas/generateSpec.ts#L0-L0).
