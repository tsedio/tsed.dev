---
title: JsonOperation from @tsed/schema
description: api documentation of JsonOperation from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation JsonOperation class
---
# JsonOperation - @tsed/schema
...
> See [/packages/specs/schema/src/domain/JsonOperation.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonOperation.ts#L0-L0).
