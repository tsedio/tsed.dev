---
url: /api/platform/platform-http/types/testing/class-fake-adapter.md
...
> See [/packages/platform/platform-http/src/testing/FakeAdapter.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/testing/FakeAdapter.ts#L0-L0).
