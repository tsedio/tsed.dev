---
url: /api/di/types/common/interfaces/interface-invoke-options.md
...
> See [/packages/di/src/common/interfaces/InvokeOptions.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/interfaces/InvokeOptions.ts#L0-L0).
