...
> See [/packages/platform/platform-http/src/common/interfaces/OnResponse.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/interfaces/OnResponse.ts#L0-L0).
