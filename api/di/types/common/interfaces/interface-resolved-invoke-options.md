...
> See [/packages/di/src/common/interfaces/ResolvedInvokeOptions.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/interfaces/ResolvedInvokeOptions.ts#L0-L0).
