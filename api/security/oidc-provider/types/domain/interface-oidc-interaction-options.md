...
> See [/packages/security/oidc-provider/src/domain/OidcInteractionOptions.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/security/oidc-provider/src/domain/OidcInteractionOptions.ts#L0-L0).
