---
title: Examples from @tsed/schema
description: api documentation of Examples from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation Examples decorator
---
# Examples - @tsed/schema
...
> See [/packages/specs/schema/src/decorators/common/examples.ts](https://github.com/tsedio/tsed/blob/v8.38.4/packages/specs/schema/src/decorators/common/examples.ts#L0-L0).
...
-   **examples** (`OpenSpecHash<OS3Example` | `OpenSpecRef>`): - Object mapping names to example definitions
