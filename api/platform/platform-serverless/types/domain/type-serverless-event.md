---
url: /api/platform/platform-serverless/types/domain/type-serverless-event.md
...
> See [/packages/platform/platform-serverless/src/domain/ServerlessEvent.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-serverless/src/domain/ServerlessEvent.ts#L0-L0).
