---
url: /api/platform/platform-http/types/common/services/class-platform-adapter.md
...
> See [/packages/platform/platform-http/src/common/services/PlatformAdapter.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/services/PlatformAdapter.ts#L0-L0).
