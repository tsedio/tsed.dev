...
> See [/packages/platform/platform-http/src/common/interfaces/ResponseErrorObject.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/interfaces/ResponseErrorObject.ts#L0-L0).
