...
> See [/packages/platform/platform-log-middleware/src/domain/PlatformLogMiddlewareSettings.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-log-middleware/src/domain/PlatformLogMiddlewareSettings.ts#L0-L0).
