---
title: PlatformCacheRefreshService from @tsed/platform-cache
description: api documentation of PlatformCacheRefreshService from @tsed/platform-cache
meta:
 - name: keywords
   description: api typescript node.js documentation PlatformCacheRefreshService class
---
# PlatformCacheRefreshService - @tsed/platform-cache
...
> See [/packages/platform/platform-cache/src/services/PlatformCacheRefreshService.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-cache/src/services/PlatformCacheRefreshService.ts#L0-L0).
