...
meta:
 - name: keywords
   description: api typescript node.js documentation Adapter class
---
...
> See [/packages/orm/adapters/src/domain/Adapter.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/orm/adapters/src/domain/Adapter.ts#L0-L0).
