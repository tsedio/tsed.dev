---
title: CustomConditionalCtx from @tsed/schema-formio
description: api documentation of CustomConditionalCtx from @tsed/schema-formio
meta:
 - name: keywords
   description: api typescript node.js documentation CustomConditionalCtx interface
---
# CustomConditionalCtx - @tsed/schema-formio
...
> See [/packages/third-parties/schema-formio/src/decorators/customConditional.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/third-parties/schema-formio/src/decorators/customConditional.ts#L0-L0).
