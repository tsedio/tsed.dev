---
url: /api/specs/schema/types/domain/interface-json-schema-options.md
...
> See [/packages/specs/schema/src/domain/JsonSchemaOptions.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonSchemaOptions.ts#L0-L0).
