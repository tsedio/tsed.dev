...
> See [/packages/orm/mikro-orm/src/filters/OptimisticLockErrorFilter.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/orm/mikro-orm/src/filters/OptimisticLockErrorFilter.ts#L0-L0).
