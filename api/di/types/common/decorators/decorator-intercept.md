---
url: /api/di/types/common/decorators/decorator-intercept.md
...
> See [/packages/di/src/common/decorators/intercept.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/decorators/intercept.ts#L0-L0).
