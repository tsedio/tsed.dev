---
url: /api/di/types/common/decorators/decorator-opts.md
...
> See [/packages/di/src/common/decorators/opts.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/decorators/opts.ts#L0-L0).
