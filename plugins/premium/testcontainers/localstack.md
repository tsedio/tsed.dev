---
url: /plugins/premium/testcontainers/localstack.md
description: >-
  A package for the Ts.ED framework to help you test your code using the
  TestContainers library with LocalStack.
---
