---
title: Docs from @tsed/openapi-utils
...
> See [/packages/specs/openapi-utils/src/decorators/docs.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/openapi-utils/src/decorators/docs.ts#L0-L0).
