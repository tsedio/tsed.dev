---
title: Children from @tsed/schema
description: api documentation of Children from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation Children decorator
---
# Children - @tsed/schema
...
> See [/packages/specs/schema/src/decorators/class/children.ts](https://github.com/tsedio/tsed/blob/v8.38.4/packages/specs/schema/src/decorators/class/children.ts#L0-L0).
...
-   **children** (`Type<any>[]`): - Controller classes to register as children
