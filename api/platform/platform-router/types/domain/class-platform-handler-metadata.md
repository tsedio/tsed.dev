---
url: /api/platform/platform-router/types/domain/class-platform-handler-metadata.md
...
Raw middleware functions are non-injectable handlers of type RAW\_FN or RAW\_ERR\_FN.
