---
title: InjectorService from @tsed/di
description: api documentation of InjectorService from @tsed/di
meta:
 - name: keywords
   description: api typescript node.js documentation InjectorService class
---
# InjectorService - @tsed/di
...
> See [/packages/di/src/common/services/InjectorService.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/services/InjectorService.ts#L0-L0).
