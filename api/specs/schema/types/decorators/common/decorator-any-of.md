---
url: /api/specs/schema/types/decorators/common/decorator-any-of.md
...
> See [/packages/specs/schema/src/decorators/common/anyOf.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/anyOf.ts#L0-L0).
