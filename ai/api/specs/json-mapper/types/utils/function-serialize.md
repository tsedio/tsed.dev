---
title: serialize from @tsed/json-mapper
...
> See [/packages/specs/json-mapper/src/utils/serialize.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/json-mapper/src/utils/serialize.ts#L0-L0).
