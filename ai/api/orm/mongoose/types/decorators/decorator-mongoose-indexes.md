---
title: MongooseIndexes from @tsed/mongoose
description: api documentation of MongooseIndexes from @tsed/mongoose
meta:
 - name: keywords
   description: api typescript node.js documentation MongooseIndexes decorator
---
# MongooseIndexes - @tsed/mongoose
...
> See [/packages/orm/mongoose/src/decorators/mongooseIndexes.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/orm/mongoose/src/decorators/mongooseIndexes.ts#L0-L0).
