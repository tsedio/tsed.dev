---
url: /api/platform/platform-http/types/common/services/class-platform-request.md
...
> See [/packages/platform/platform-http/src/common/services/PlatformRequest.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/services/PlatformRequest.ts#L0-L0).
