---
url: /api/di/types/common/domain/class-container.md
...
> See [/packages/di/src/common/domain/Container.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/domain/Container.ts#L0-L0).
