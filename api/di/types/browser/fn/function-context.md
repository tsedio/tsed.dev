---
url: /api/di/types/browser/fn/function-context.md
...
> See [/packages/di/src/browser/fn/context.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/browser/fn/context.ts#L0-L0).
