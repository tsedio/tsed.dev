---
url: /api/specs/schema/types/decorators/common/const-max-length.md
...
> See [/packages/specs/schema/src/decorators/common/maxLength.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/maxLength.ts#L0-L0).
