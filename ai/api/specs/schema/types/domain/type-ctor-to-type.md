---
title: CtorToType from @tsed/schema
description: api documentation of CtorToType from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation CtorToType type
---
# CtorToType - @tsed/schema
...
> See [/packages/specs/schema/src/domain/types.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/types.ts#L0-L0).
