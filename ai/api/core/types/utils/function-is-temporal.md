---
title: isTemporal from @tsed/core
description: api documentation of isTemporal from @tsed/core
meta:
 - name: keywords
   description: api typescript node.js documentation isTemporal function
---
# isTemporal - @tsed/core
...
> See [/packages/core/src/utils/isTemporal.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/core/src/utils/isTemporal.ts#L0-L0).
