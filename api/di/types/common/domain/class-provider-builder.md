---
url: /api/di/types/common/domain/class-provider-builder.md
...
> See [/packages/di/src/common/domain/ProviderBuilder.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/domain/ProviderBuilder.ts#L0-L0).
