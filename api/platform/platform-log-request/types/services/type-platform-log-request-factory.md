...
> See [/packages/platform/platform-log-request/src/services/PlatformLogRequestFactory.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-log-request/src/services/PlatformLogRequestFactory.ts#L0-L0).
