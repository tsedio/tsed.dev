---
title: Optional from @tsed/schema
description: api documentation of Optional from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation Optional decorator
---
# Optional - @tsed/schema
...
> See [/packages/specs/schema/src/decorators/common/optional.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/optional.ts#L0-L0).
