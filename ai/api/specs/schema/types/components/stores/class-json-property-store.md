---
title: JsonPropertyStore from @tsed/schema
description: api documentation of JsonPropertyStore from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation JsonPropertyStore class
---
# JsonPropertyStore - @tsed/schema
...
> See [/packages/specs/schema/src/components/stores/JsonPropertyStore.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/components/stores/JsonPropertyStore.ts#L0-L0).
