---
title: CookiesParams from @tsed/platform-params
...
---
# CookiesParams - @tsed/platform-params
...
> See [/packages/platform/platform-params/src/decorators/cookies.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-params/src/decorators/cookies.ts#L0-L0).
