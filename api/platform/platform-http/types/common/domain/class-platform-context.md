---
url: /api/platform/platform-http/types/common/domain/class-platform-context.md
...
> See [/packages/platform/platform-http/src/common/domain/PlatformContext.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/domain/PlatformContext.ts#L0-L0).
