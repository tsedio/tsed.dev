---
title: Nullable from @tsed/schema
description: api documentation of Nullable from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation Nullable decorator
---
# Nullable - @tsed/schema
...
> See [/packages/specs/schema/src/decorators/common/nullable.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/nullable.ts#L0-L0).
