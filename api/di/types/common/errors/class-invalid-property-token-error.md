...
> See [/packages/di/src/common/errors/InvalidPropertyTokenError.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/errors/InvalidPropertyTokenError.ts#L0-L0).
