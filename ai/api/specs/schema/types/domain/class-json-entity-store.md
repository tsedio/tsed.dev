---
title: JsonEntityStore from @tsed/schema
description: api documentation of JsonEntityStore from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation JsonEntityStore class
---
# JsonEntityStore - @tsed/schema
...
> See [/packages/specs/schema/src/domain/JsonEntityStore.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonEntityStore.ts#L0-L0).
