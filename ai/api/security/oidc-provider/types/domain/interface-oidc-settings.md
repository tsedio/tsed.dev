---
title: OidcSettings from @tsed/oidc-provider
description: api documentation of OidcSettings from @tsed/oidc-provider
meta:
 - name: keywords
   description: api typescript node.js documentation OidcSettings interface
---
# OidcSettings - @tsed/oidc-provider
...
> See [/packages/security/oidc-provider/src/domain/OidcSettings.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/security/oidc-provider/src/domain/OidcSettings.ts#L0-L0).
