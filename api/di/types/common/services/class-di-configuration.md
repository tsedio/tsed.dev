---
url: /api/di/types/common/services/class-di-configuration.md
...
> See [/packages/di/src/common/services/DIConfiguration.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/services/DIConfiguration.ts#L0-L0).
