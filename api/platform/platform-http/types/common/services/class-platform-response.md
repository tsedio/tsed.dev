---
url: /api/platform/platform-http/types/common/services/class-platform-response.md
...
> See [/packages/platform/platform-http/src/common/services/PlatformResponse.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/services/PlatformResponse.ts#L0-L0).
