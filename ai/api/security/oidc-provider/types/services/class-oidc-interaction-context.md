---
title: OidcInteractionContext from @tsed/oidc-provider
description: api documentation of OidcInteractionContext from @tsed/oidc-provider
meta:
 - name: keywords
   description: api typescript node.js documentation OidcInteractionContext class
---
# OidcInteractionContext - @tsed/oidc-provider
...
> See [/packages/security/oidc-provider/src/services/OidcInteractionContext.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/security/oidc-provider/src/services/OidcInteractionContext.ts#L0-L0).
