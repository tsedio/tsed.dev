---
url: /api/di/types/common/interfaces/interface-di-logger.md
...
> See [/packages/di/src/common/interfaces/DILogger.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/interfaces/DILogger.ts#L0-L0).
