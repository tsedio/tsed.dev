---
url: /api/core/types/types/type-decorator-parameters.md
...
> See [/packages/core/src/types/DecoratorParameters.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/core/src/types/DecoratorParameters.ts#L0-L0).
