---
title: toMap from @tsed/core
description: api documentation of toMap from @tsed/core
meta:
 - name: keywords
   description: api typescript node.js documentation toMap function
---
# toMap - @tsed/core
...
> See [/packages/core/src/utils/toMap.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/core/src/utils/toMap.ts#L0-L0).
