---
title: DynamicRef from @tsed/mongoose
description: api documentation of DynamicRef from @tsed/mongoose
meta:
 - name: keywords
   description: api typescript node.js documentation DynamicRef decorator
---
# DynamicRef - @tsed/mongoose
...
> See [/packages/orm/mongoose/src/decorators/dynamicRef.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/orm/mongoose/src/decorators/dynamicRef.ts#L0-L0).
