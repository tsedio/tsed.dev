---
url: /api/platform/platform-koa/types/decorators/decorator-state.md
...
> See [/packages/platform/platform-koa/src/decorators/state.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-koa/src/decorators/state.ts#L0-L0).
