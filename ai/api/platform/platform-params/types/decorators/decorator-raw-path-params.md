---
title: RawPathParams from @tsed/platform-params
description: api documentation of RawPathParams from @tsed/platform-params
meta:
 - name: keywords
   description: api typescript node.js documentation RawPathParams decorator
---
# RawPathParams - @tsed/platform-params
...
> See [/packages/platform/platform-params/src/decorators/pathParams.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-params/src/decorators/pathParams.ts#L0-L0).
