...
> See [/packages/config/core/src/fn/injectConfigSource.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/config/core/src/fn/injectConfigSource.ts#L0-L0).
