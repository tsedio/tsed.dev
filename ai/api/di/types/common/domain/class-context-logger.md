...
meta:
 - name: keywords
   description: api typescript node.js documentation ContextLogger class
---
...
> See [/packages/di/src/common/domain/ContextLogger.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/domain/ContextLogger.ts#L0-L0).
