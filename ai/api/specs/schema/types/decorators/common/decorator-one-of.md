...
meta:
 - name: keywords
   description: api typescript node.js documentation OneOf decorator
---
# OneOf - @tsed/schema
...
> See [/packages/specs/schema/src/decorators/common/oneOf.ts](https://github.com/tsedio/tsed/blob/v8.38.4/packages/specs/schema/src/decorators/common/oneOf.ts#L0-L0).

## Overview

```ts
function OneOf(...oneOf: Parameters<JsonSchema["oneOf"]>[0]): (...args: any[]) => any;
```

-   **oneOf** (`Parameters<JsonSchema["oneOf"]>[0]`): - Schemas where exactly one must be satisfied
