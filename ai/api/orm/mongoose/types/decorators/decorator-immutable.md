---
title: Immutable from @tsed/mongoose
description: api documentation of Immutable from @tsed/mongoose
meta:
 - name: keywords
   description: api typescript node.js documentation Immutable decorator
---
# Immutable - @tsed/mongoose
...
> See [/packages/orm/mongoose/src/decorators/immutable.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/orm/mongoose/src/decorators/immutable.ts#L0-L0).
