---
url: /api/di/types/common/decorators/decorator-service.md
...
> See [/packages/di/src/common/decorators/service.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/decorators/service.ts#L0-L0).
