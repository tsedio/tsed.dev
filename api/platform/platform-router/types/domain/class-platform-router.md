---
url: /api/platform/platform-router/types/domain/class-platform-router.md
...
> See [/packages/platform/platform-router/src/domain/PlatformRouter.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-router/src/domain/PlatformRouter.ts#L0-L0).
