---
url: /api/specs/json-mapper/types/components/class-temporal-mapper.md
...
> See [/packages/specs/json-mapper/src/components/TemporalMapper.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/json-mapper/src/components/TemporalMapper.ts#L0-L0).
