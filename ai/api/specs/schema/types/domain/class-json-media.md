---
title: JsonMedia from @tsed/schema
description: api documentation of JsonMedia from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation JsonMedia class
---
# JsonMedia - @tsed/schema
...
> See [/packages/specs/schema/src/domain/JsonMedia.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonMedia.ts#L0-L0).
