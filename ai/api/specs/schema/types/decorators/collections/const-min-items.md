---
title: MinItems from @tsed/schema
description: api documentation of MinItems from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation MinItems const
---
# MinItems - @tsed/schema
...
> See [/packages/specs/schema/src/decorators/collections/minItems.ts](https://github.com/tsedio/tsed/blob/v8.38.4/packages/specs/schema/src/decorators/collections/minItems.ts#L0-L0).
