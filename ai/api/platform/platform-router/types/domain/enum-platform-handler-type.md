...
> See [/packages/platform/platform-router/src/domain/PlatformHandlerType.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-router/src/domain/PlatformHandlerType.ts#L0-L0).
