---
url: /api/specs/schema/types/decorators/common/decorator-const.md
...
> See [/packages/specs/schema/src/decorators/common/const.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/const.ts#L0-L0).
