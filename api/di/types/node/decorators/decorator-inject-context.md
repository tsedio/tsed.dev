---
url: /api/di/types/node/decorators/decorator-inject-context.md
...
> See [/packages/di/src/node/decorators/injectContext.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/node/decorators/injectContext.ts#L0-L0).
