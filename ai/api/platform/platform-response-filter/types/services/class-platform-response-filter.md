---
title: PlatformResponseFilter from @tsed/platform-response-filter
description: api documentation of PlatformResponseFilter from @tsed/platform-response-filter
meta:
 - name: keywords
   description: api typescript node.js documentation PlatformResponseFilter class
---
# PlatformResponseFilter - @tsed/platform-response-filter
...
> See [/packages/platform/platform-response-filter/src/services/PlatformResponseFilter.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-response-filter/src/services/PlatformResponseFilter.ts#L0-L0).
