...
> See [/packages/security/oidc-provider/src/domain/OidcInteractionPromptProps.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/security/oidc-provider/src/domain/OidcInteractionPromptProps.ts#L0-L0).
