---
url: /api/specs/schema/types/decorators/class/decorator-discriminator-value.md
description: api documentation of DiscriminatorValue from @tsed/schema
---
...
> See [/packages/specs/schema/src/decorators/class/discriminatorValue.ts](https://github.com/tsedio/tsed/blob/v8.38.4/packages/specs/schema/src/decorators/class/discriminatorValue.ts#L0-L0).
...
* **value** (`string`): Optional. - The discriminator value (auto-generated if omitted)

* **values** (`string[]`): - Additional alias values for this subclass
...
If no value is provided, it auto-generates from the class name in snake\_case:
...
* If omitted, value is auto-generated from class name (snake\_case)
