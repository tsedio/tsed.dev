---
title: concatPath from @tsed/schema
...
> See [/packages/specs/schema/src/utils/concatPath.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/utils/concatPath.ts#L0-L0).
