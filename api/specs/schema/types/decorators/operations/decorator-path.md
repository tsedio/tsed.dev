...
> See [/packages/specs/schema/src/decorators/operations/path.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/operations/path.ts#L0-L0).
