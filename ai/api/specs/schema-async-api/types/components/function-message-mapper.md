---
title: messageMapper from @tsed/schema-async-api
...
> See [/packages/specs/schema-async-api/src/components/messageMapper.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema-async-api/src/components/messageMapper.ts#L0-L0).
