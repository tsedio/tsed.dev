---
url: /api/core/types/types/class-metadata.md
...
> See [/packages/core/src/types/Metadata.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/core/src/types/Metadata.ts#L0-L0).
...
Gets the metadata value for the provided metadata DESIGN\_TYPE on the target object or its prototype chain.
...
Gets the metadata value for the provided metadata DESIGN\_RETURN\_TYPE on the target object or its prototype chain.
...
Set the metadata value for the provided metadata DESIGN\_PARAM\_TYPES on the target object or its prototype chain.
...
Gets the metadata value for the provided metadata DESIGN\_PARAM\_TYPES on the target object or its prototype chain.
