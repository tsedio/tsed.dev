---
url: /api/specs/json-mapper/types/components/class-primitive-mapper.md
...
> See [/packages/specs/json-mapper/src/components/PrimitiveMapper.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/json-mapper/src/components/PrimitiveMapper.ts#L0-L0).
