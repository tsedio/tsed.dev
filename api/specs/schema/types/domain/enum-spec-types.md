---
url: /api/specs/schema/types/domain/enum-spec-types.md
...
> See [/packages/specs/schema/src/domain/SpecTypes.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/SpecTypes.ts#L0-L0).
