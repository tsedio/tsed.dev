---
title: JsonParameter from @tsed/schema
description: api documentation of JsonParameter from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation JsonParameter class
---
# JsonParameter - @tsed/schema
...
> See [/packages/specs/schema/src/domain/JsonParameter.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonParameter.ts#L0-L0).
