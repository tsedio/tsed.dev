...
> See [/packages/specs/json-mapper/src/domain/JsonSerializerOptions.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/json-mapper/src/domain/JsonSerializerOptions.ts#L0-L0).
