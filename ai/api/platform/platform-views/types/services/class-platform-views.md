---
title: PlatformViews from @tsed/platform-views
description: api documentation of PlatformViews from @tsed/platform-views
meta:
 - name: keywords
   description: api typescript node.js documentation PlatformViews class
---
...
> See [/packages/platform/platform-views/src/services/PlatformViews.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-views/src/services/PlatformViews.ts#L0-L0).
