---
title: OverrideProvider from @tsed/di
...
> See [/packages/di/src/common/decorators/overrideProvider.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/decorators/overrideProvider.ts#L0-L0).
