---
title: PlatformLogMiddleware from @tsed/platform-log-middleware
description: api documentation of PlatformLogMiddleware from @tsed/platform-log-middleware
meta:
 - name: keywords
   description: api typescript node.js documentation PlatformLogMiddleware class
---
# PlatformLogMiddleware - @tsed/platform-log-middleware
...
> See [/packages/platform/platform-log-middleware/src/middlewares/PlatformLogMiddleware.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-log-middleware/src/middlewares/PlatformLogMiddleware.ts#L0-L0).
