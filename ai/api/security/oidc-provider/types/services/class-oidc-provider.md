---
title: OidcProvider from @tsed/oidc-provider
description: api documentation of OidcProvider from @tsed/oidc-provider
meta:
 - name: keywords
   description: api typescript node.js documentation OidcProvider class
---
# OidcProvider - @tsed/oidc-provider
...
> See [/packages/security/oidc-provider/src/services/OidcProvider.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/security/oidc-provider/src/services/OidcProvider.ts#L0-L0).
