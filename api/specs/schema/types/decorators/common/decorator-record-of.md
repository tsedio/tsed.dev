---
url: /api/specs/schema/types/decorators/common/decorator-record-of.md
...
> See [/packages/specs/schema/src/decorators/common/recordOf.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/recordOf.ts#L0-L0).
