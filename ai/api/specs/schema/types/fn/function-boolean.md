---
title: boolean from @tsed/schema
description: api documentation of boolean from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation boolean function
---
# boolean - @tsed/schema
...
> See [/packages/specs/schema/src/fn/boolean.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/fn/boolean.ts#L0-L0).
