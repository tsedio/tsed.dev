---
url: >-
  /api/platform/platform-response-filter/types/errors/class-template-render-error.md
...
> See [/packages/platform/platform-response-filter/src/errors/TemplateRenderError.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-response-filter/src/errors/TemplateRenderError.ts#L0-L0).
