...
meta:
 - name: keywords
   description: api typescript node.js documentation Injectable decorator
---
# Injectable - @tsed/di
...
> See [/packages/di/src/common/decorators/injectable.ts](https://github.com/tsedio/tsed/blob/v8.38.4/packages/di/src/common/decorators/injectable.ts#L0-L0).

## Overview

```ts
function Injectable(options?: Partial<ProviderOpts>): ClassDecorator;
```

-   **options** (`Partial<ProviderOpts>`): Optional. Provider configuration options
