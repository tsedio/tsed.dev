---
title: DiscriminatorKey from @tsed/schema
description: api documentation of DiscriminatorKey from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation DiscriminatorKey decorator
---
# DiscriminatorKey - @tsed/schema

## Usage

```typescript
import { DiscriminatorKey } from "@tsed/schema";
```

> See [/packages/specs/schema/src/decorators/common/discriminatorKey.ts](https://github.com/tsedio/tsed/blob/v8.38.4/packages/specs/schema/src/decorators/common/discriminatorKey.ts#L0-L0).

## Overview

```ts
function DiscriminatorKey(): PropertyDecorator;
```
