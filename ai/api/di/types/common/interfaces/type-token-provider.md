---
title: TokenProvider from @tsed/di
description: api documentation of TokenProvider from @tsed/di
meta:
 - name: keywords
   description: api typescript node.js documentation TokenProvider type
---
# TokenProvider - @tsed/di
...
> See [/packages/di/src/common/interfaces/TokenProvider.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/interfaces/TokenProvider.ts#L0-L0).
