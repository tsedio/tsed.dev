---
title: ProviderOpts from @tsed/di
description: api documentation of ProviderOpts from @tsed/di
meta:
 - name: keywords
   description: api typescript node.js documentation ProviderOpts interface
---
# ProviderOpts - @tsed/di
...
> See [/packages/di/src/common/interfaces/ProviderOpts.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/interfaces/ProviderOpts.ts#L0-L0).
