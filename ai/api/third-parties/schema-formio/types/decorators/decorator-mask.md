---
title: Mask from @tsed/schema-formio
description: api documentation of Mask from @tsed/schema-formio
meta:
 - name: keywords
   description: api typescript node.js documentation Mask decorator
---
# Mask - @tsed/schema-formio
...
> See [/packages/third-parties/schema-formio/src/decorators/mask.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/third-parties/schema-formio/src/decorators/mask.ts#L0-L0).
