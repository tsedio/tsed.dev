...
> See [/packages/specs/json-mapper/src/components/SymbolMapper.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/json-mapper/src/components/SymbolMapper.ts#L0-L0).
