---
url: /api/specs/schema/types/domain/class-json-lazy-ref.md
...
> See [/packages/specs/schema/src/domain/JsonLazyRef.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonLazyRef.ts#L0-L0).
