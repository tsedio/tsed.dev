...
meta:
 - name: keywords
   description: api typescript node.js documentation OptionalLazyInject decorator
---
...
> See [/packages/di/src/common/decorators/lazyInject.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/decorators/lazyInject.ts#L0-L0).
