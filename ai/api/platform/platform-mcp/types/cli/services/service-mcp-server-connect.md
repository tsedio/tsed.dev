...
> See [/packages/platform/platform-mcp/src/cli/services/mcpServerConnect.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-mcp/src/cli/services/mcpServerConnect.ts#L0-L0).
