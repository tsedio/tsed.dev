---
url: /api/specs/schema/types/decorators/common/decorator-error-msg.md
...
> See [/packages/specs/schema/src/decorators/common/errorMsg.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/errorMsg.ts#L0-L0).
