...
> See [/packages/specs/json-mapper/src/decorators/afterDeserialize.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/json-mapper/src/decorators/afterDeserialize.ts#L0-L0).
