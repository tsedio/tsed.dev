---
title: WriteOnly from @tsed/schema
description: api documentation of WriteOnly from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation WriteOnly decorator
---
# WriteOnly - @tsed/schema
...
> See [/packages/specs/schema/src/decorators/common/writeOnly.ts](https://github.com/tsedio/tsed/blob/v8.38.4/packages/specs/schema/src/decorators/common/writeOnly.ts#L0-L0).
...
-   **writeOnly** (`boolean`): Optional. - Whether the property is write-only (default: true)
