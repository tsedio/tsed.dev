...
> See [/packages/config/core/src/providers/json/JsonConfigSource.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/config/core/src/providers/json/JsonConfigSource.ts#L0-L0).
