---
title: InterceptorContext from @tsed/di
...
> See [/packages/di/src/common/interfaces/InterceptorContext.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/interfaces/InterceptorContext.ts#L0-L0).
