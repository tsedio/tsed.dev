---
title: JsonSchemaObject from @tsed/schema
description: api documentation of JsonSchemaObject from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation JsonSchemaObject interface
---
# JsonSchemaObject - @tsed/schema
...
> See [/packages/specs/schema/src/domain/JsonSchema.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonSchema.ts#L0-L0).
