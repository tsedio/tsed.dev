---
title: LambdaClientRequest from @tsed/platform-serverless-testing
description: api documentation of LambdaClientRequest from @tsed/platform-serverless-testing
meta:
 - name: keywords
   description: api typescript node.js documentation LambdaClientRequest class
---
# LambdaClientRequest - @tsed/platform-serverless-testing
