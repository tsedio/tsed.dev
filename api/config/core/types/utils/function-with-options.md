---
url: /api/config/core/types/utils/function-with-options.md
...
> See [/packages/config/core/src/utils/withOptions.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/config/core/src/utils/withOptions.ts#L0-L0).
