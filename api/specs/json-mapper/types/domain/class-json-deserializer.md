---
url: /api/specs/json-mapper/types/domain/class-json-deserializer.md
...
> See [/packages/specs/json-mapper/src/domain/JsonDeserializer.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/json-mapper/src/domain/JsonDeserializer.ts#L0-L0).
