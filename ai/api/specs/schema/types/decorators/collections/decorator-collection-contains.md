---
title: CollectionContains from @tsed/schema
description: api documentation of CollectionContains from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation CollectionContains decorator
---
# CollectionContains - @tsed/schema
...
> See [/packages/specs/schema/src/decorators/collections/collectionContains.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/collections/collectionContains.ts#L0-L0).
