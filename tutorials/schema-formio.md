---
url: /tutorials/schema-formio.md
description: >-
  This tutorial shows how to use the @tsed/schema-formio package to generate
  Form.io compatible schemas from TypeScript classes using decorators.
---
