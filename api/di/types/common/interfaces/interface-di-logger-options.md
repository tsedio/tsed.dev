---
url: /api/di/types/common/interfaces/interface-di-logger-options.md
...
> See [/packages/di/src/common/interfaces/DILoggerOptions.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/interfaces/DILoggerOptions.ts#L0-L0).
