...
> See [/packages/specs/schema/src/decorators/common/examples.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/examples.ts#L0-L0).
