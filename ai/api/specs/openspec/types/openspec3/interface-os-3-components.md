---
title: OS3Components from @tsed/openspec
description: api documentation of OS3Components from @tsed/openspec
meta:
 - name: keywords
   description: api typescript node.js documentation OS3Components interface
---
# OS3Components - @tsed/openspec
...
> See [/packages/specs/openspec/src/openspec3/OS3Components.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/openspec/src/openspec3/OS3Components.ts#L0-L0).
