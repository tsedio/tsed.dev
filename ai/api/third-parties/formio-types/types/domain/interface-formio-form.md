---
title: FormioForm from @tsed/formio-types
description: api documentation of FormioForm from @tsed/formio-types
meta:
 - name: keywords
   description: api typescript node.js documentation FormioForm interface
---
# FormioForm - @tsed/formio-types
...
> See [/packages/third-parties/formio-types/src/domain/FormioForm.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/third-parties/formio-types/src/domain/FormioForm.ts#L0-L0).
