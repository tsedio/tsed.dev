---
title: JsonOperationRoute from @tsed/schema
description: api documentation of JsonOperationRoute from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation JsonOperationRoute class
---
# JsonOperationRoute - @tsed/schema
...
> See [/packages/specs/schema/src/domain/JsonOperationRoute.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonOperationRoute.ts#L0-L0).
