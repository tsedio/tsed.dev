---
url: >-
  /api/platform/platform-http/types/common/decorators/multer/const-multipart-file.md
...
> See [/packages/platform/platform-http/src/common/decorators/multer/multipartFile.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/decorators/multer/multipartFile.ts#L0-L0).
