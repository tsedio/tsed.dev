---
url: /api/platform/platform-express/types/components/class-platform-express.md
...
> See [/packages/platform/platform-express/src/components/PlatformExpress.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-express/src/components/PlatformExpress.ts#L0-L0).
