---
title: PlatformBuilder from @tsed/platform-http
description: api documentation of PlatformBuilder from @tsed/platform-http
meta:
 - name: keywords
   description: api typescript node.js documentation PlatformBuilder class
---
# PlatformBuilder - @tsed/platform-http
...
> See [/packages/platform/platform-http/src/common/builder/PlatformBuilder.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/builder/PlatformBuilder.ts#L0-L0).
...
Return the settings configured by the decorator [Configuration](/ai/api/di/types/common/decorators/decorator-configuration.md).
...
Add classes decorated by [Controller](/ai/api/di/types/common/decorators/decorator-controller.md) to components container.
