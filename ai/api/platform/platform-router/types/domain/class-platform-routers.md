---
title: PlatformRouters from @tsed/platform-router
description: api documentation of PlatformRouters from @tsed/platform-router
meta:
 - name: keywords
   description: api typescript node.js documentation PlatformRouters class
---
# PlatformRouters - @tsed/platform-router
...
> See [/packages/platform/platform-router/src/domain/PlatformRouters.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-router/src/domain/PlatformRouters.ts#L0-L0).
