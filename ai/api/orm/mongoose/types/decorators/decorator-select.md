---
title: Select from @tsed/mongoose
...
> See [/packages/orm/mongoose/src/decorators/select.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/orm/mongoose/src/decorators/select.ts#L0-L0).
