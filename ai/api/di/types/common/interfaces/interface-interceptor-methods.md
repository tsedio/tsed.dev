...
> See [/packages/di/src/common/interfaces/InterceptorMethods.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/interfaces/InterceptorMethods.ts#L0-L0).
