---
title: OpenSpecJsonSchema from @tsed/openspec
description: api documentation of OpenSpecJsonSchema from @tsed/openspec
meta:
 - name: keywords
   description: api typescript node.js documentation OpenSpecJsonSchema interface
---
# OpenSpecJsonSchema - @tsed/openspec
...
> See [/packages/specs/openspec/src/common/OpenSpecJsonSchema.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/openspec/src/common/OpenSpecJsonSchema.ts#L0-L0).
