...
> See [/packages/config/core/src/utils/getConfigSources.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/config/core/src/utils/getConfigSources.ts#L0-L0).
