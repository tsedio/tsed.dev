---
title: AdditionalProperties from @tsed/schema
description: api documentation of AdditionalProperties from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation AdditionalProperties decorator
---
# AdditionalProperties - @tsed/schema
...
> See [/packages/specs/schema/src/decorators/common/additionalProperties.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/additionalProperties.ts#L0-L0).
