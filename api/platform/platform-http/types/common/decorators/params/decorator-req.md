---
url: /api/platform/platform-http/types/common/decorators/params/decorator-req.md
...
> See [/packages/platform/platform-http/src/common/decorators/params/request.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/decorators/params/request.ts#L0-L0).
