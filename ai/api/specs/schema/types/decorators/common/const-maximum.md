---
title: Maximum from @tsed/schema
description: api documentation of Maximum from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation Maximum const
---
# Maximum - @tsed/schema
...
> See [/packages/specs/schema/src/decorators/common/maximum.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/maximum.ts#L0-L0).
