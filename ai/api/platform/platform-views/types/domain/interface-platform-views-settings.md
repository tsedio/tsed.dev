---
title: PlatformViewsSettings from @tsed/platform-views
description: api documentation of PlatformViewsSettings from @tsed/platform-views
meta:
 - name: keywords
   description: api typescript node.js documentation PlatformViewsSettings interface
---
# PlatformViewsSettings - @tsed/platform-views
