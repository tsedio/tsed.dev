---
url: /api/platform/platform-http/types/common/services/class-platform.md
...
> See [/packages/platform/platform-http/src/common/services/Platform.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/services/Platform.ts#L0-L0).
