---
url: /plugins/premium/config-source/ioredis.md
description: >-
  A powerful plugin for Ts.ED to manage your application configuration in Redis
  and sync changes in real time.
---
