---
url: /api/di/types/common/decorators/decorator-configuration.md
...
> See [/packages/di/src/common/decorators/configuration.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/decorators/configuration.ts#L0-L0).
