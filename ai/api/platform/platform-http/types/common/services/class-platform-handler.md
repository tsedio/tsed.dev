---
title: PlatformHandler from @tsed/platform-http
description: api documentation of PlatformHandler from @tsed/platform-http
meta:
 - name: keywords
   description: api typescript node.js documentation PlatformHandler class
---
# PlatformHandler - @tsed/platform-http
...
> See [/packages/platform/platform-http/src/common/services/PlatformHandler.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/services/PlatformHandler.ts#L0-L0).
