---
url: /api/specs/schema/types/fn/function-string.md
...
> See [/packages/specs/schema/src/fn/string.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/fn/string.ts#L0-L0).
