---
title: number from @tsed/schema
description: api documentation of number from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation number function
---
# number - @tsed/schema
...
> See [/packages/specs/schema/src/fn/number.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/fn/number.ts#L0-L0).
