---
title: DITest from @tsed/di
description: api documentation of DITest from @tsed/di
meta:
 - name: keywords
   description: api typescript node.js documentation DITest class
---
# DITest - @tsed/di
...
> See [/packages/di/src/node/services/DITest.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/node/services/DITest.ts#L0-L0).
