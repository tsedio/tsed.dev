---
title: ControllerProvider from @tsed/di
description: api documentation of ControllerProvider from @tsed/di
meta:
 - name: keywords
   description: api typescript node.js documentation ControllerProvider const
---
# ControllerProvider - @tsed/di
...
> See [/packages/di/src/common/domain/ControllerProvider.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/domain/ControllerProvider.ts#L0-L0).
