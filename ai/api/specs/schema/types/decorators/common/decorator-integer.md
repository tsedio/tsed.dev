...
> See [/packages/specs/schema/src/decorators/common/integer.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/integer.ts#L0-L0).
