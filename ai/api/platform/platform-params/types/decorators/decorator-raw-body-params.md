---
title: RawBodyParams from @tsed/platform-params
description: api documentation of RawBodyParams from @tsed/platform-params
meta:
 - name: keywords
   description: api typescript node.js documentation RawBodyParams decorator
---
# RawBodyParams - @tsed/platform-params
...
> See [/packages/platform/platform-params/src/decorators/bodyParams.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-params/src/decorators/bodyParams.ts#L0-L0).
