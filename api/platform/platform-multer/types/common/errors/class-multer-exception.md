...
> See [/packages/platform/platform-multer/src/common/errors/MulterException.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-multer/src/common/errors/MulterException.ts#L0-L0).
