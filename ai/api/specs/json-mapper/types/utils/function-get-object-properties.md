...
> See [/packages/specs/json-mapper/src/utils/getObjectProperties.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/json-mapper/src/utils/getObjectProperties.ts#L0-L0).
