...
> See [/packages/security/passport/src/errors/PassportMessage.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/security/passport/src/errors/PassportMessage.ts#L0-L0).
