...
> See [/packages/platform/platform-http/src/common/domain/AnyToPromiseWithCtx.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/domain/AnyToPromiseWithCtx.ts#L0-L0).
