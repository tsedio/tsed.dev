---
title: AlterActions from @tsed/formio
description: api documentation of AlterActions from @tsed/formio
meta:
 - name: keywords
   description: api typescript node.js documentation AlterActions class
---
# AlterActions - @tsed/formio
...
> See [/packages/third-parties/formio/src/components/AlterActions.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/third-parties/formio/src/components/AlterActions.ts#L0-L0).
