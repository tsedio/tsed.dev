...
meta:
 - name: keywords
   description: api typescript node.js documentation AllOf decorator
---
# AllOf - @tsed/schema
...
> See [/packages/specs/schema/src/decorators/common/allOf.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/allOf.ts#L0-L0).
