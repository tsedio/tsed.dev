---
url: /api/platform/platform-mcp/types/common/decorators/decorator-prompt.md
...
> See [/packages/platform/platform-mcp/src/common/decorators/prompt.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-mcp/src/common/decorators/prompt.ts#L0-L0).
