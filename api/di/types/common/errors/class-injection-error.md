---
url: /api/di/types/common/errors/class-injection-error.md
...
> See [/packages/di/src/common/errors/InjectionError.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/errors/InjectionError.ts#L0-L0).
