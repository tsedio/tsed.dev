---
title: PlatformTest from @tsed/platform-http
description: api documentation of PlatformTest from @tsed/platform-http
meta:
 - name: keywords
   description: api typescript node.js documentation PlatformTest class
---
# PlatformTest - @tsed/platform-http
...
> See [/packages/platform/platform-http/src/testing/PlatformTest.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/testing/PlatformTest.ts#L0-L0).
