---
url: /api/specs/schema/types/decorators/common/const-required.md
...
> See [/packages/specs/schema/src/decorators/common/required.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/required.ts#L0-L0).
