---
title: RawQueryParams from @tsed/platform-params
description: api documentation of RawQueryParams from @tsed/platform-params
meta:
 - name: keywords
   description: api typescript node.js documentation RawQueryParams decorator
---
# RawQueryParams - @tsed/platform-params
...
> See [/packages/platform/platform-params/src/decorators/queryParams.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-params/src/decorators/queryParams.ts#L0-L0).
