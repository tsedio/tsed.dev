...
> See [/packages/platform/platform-response-filter/src/services/PlatformContentTypesContainer.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-response-filter/src/services/PlatformContentTypesContainer.ts#L0-L0).
