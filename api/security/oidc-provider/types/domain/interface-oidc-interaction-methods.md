...
> See [/packages/security/oidc-provider/src/domain/OidcInteractionMethods.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/security/oidc-provider/src/domain/OidcInteractionMethods.ts#L0-L0).
