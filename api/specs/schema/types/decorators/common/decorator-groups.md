---
url: /api/specs/schema/types/decorators/common/decorator-groups.md
...
> See [/packages/specs/schema/src/decorators/common/groups.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/groups.ts#L0-L0).
