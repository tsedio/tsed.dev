---
title: GraphQLWSModule from @tsed/graphql-ws
...
> See [/packages/graphql/graphql-ws/src/GraphQLWSModule.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/graphql/graphql-ws/src/GraphQLWSModule.ts#L0-L0).
