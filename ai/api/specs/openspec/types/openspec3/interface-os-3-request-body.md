---
title: OS3RequestBody from @tsed/openspec
description: api documentation of OS3RequestBody from @tsed/openspec
meta:
 - name: keywords
   description: api typescript node.js documentation OS3RequestBody interface
---
# OS3RequestBody - @tsed/openspec
...
> See [/packages/specs/openspec/src/openspec3/OS3RequestBody.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/openspec/src/openspec3/OS3RequestBody.ts#L0-L0).
