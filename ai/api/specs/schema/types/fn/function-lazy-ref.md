---
title: lazyRef from @tsed/schema
...
> See [/packages/specs/schema/src/fn/lazyRef.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/fn/lazyRef.ts#L0-L0).
