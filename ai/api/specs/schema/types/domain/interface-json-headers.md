---
title: JsonHeaders from @tsed/schema
description: api documentation of JsonHeaders from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation JsonHeaders interface
---
# JsonHeaders - @tsed/schema
...
> See [/packages/specs/schema/src/domain/JsonOpenSpec.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonOpenSpec.ts#L0-L0).
