---
url: /api/specs/schema/types/fn/function-map.md
...
> See [/packages/specs/schema/src/fn/collection.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/fn/collection.ts#L0-L0).
