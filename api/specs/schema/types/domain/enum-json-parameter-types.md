---
url: /api/specs/schema/types/domain/enum-json-parameter-types.md
...
> See [/packages/specs/schema/src/domain/JsonParameterTypes.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonParameterTypes.ts#L0-L0).
