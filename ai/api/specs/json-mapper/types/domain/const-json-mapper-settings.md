---
title: JsonMapperSettings from @tsed/json-mapper
...
> See [/packages/specs/json-mapper/src/domain/JsonMapperSettings.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/json-mapper/src/domain/JsonMapperSettings.ts#L0-L0).
