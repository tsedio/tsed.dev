---
title: HeaderParams from @tsed/platform-params
...
---
# HeaderParams - @tsed/platform-params
...
> See [/packages/platform/platform-params/src/decorators/headerParams.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-params/src/decorators/headerParams.ts#L0-L0).
