---
title: Example from @tsed/schema
...
> See [/packages/specs/schema/src/decorators/common/example.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/common/example.ts#L0-L0).
