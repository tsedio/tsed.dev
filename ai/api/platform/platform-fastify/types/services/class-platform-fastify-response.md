---
title: PlatformFastifyResponse from @tsed/platform-fastify
description: api documentation of PlatformFastifyResponse from @tsed/platform-fastify
meta:
 - name: keywords
   description: api typescript node.js documentation PlatformFastifyResponse class
---
# PlatformFastifyResponse - @tsed/platform-fastify
...
> See [/packages/platform/platform-fastify/src/services/PlatformFastifyResponse.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-fastify/src/services/PlatformFastifyResponse.ts#L0-L0).
