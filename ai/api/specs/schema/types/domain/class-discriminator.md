---
title: Discriminator from @tsed/schema
description: api documentation of Discriminator from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation Discriminator class
---
# Discriminator - @tsed/schema
...
> See [/packages/specs/schema/src/domain/JsonDiscriminator.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonDiscriminator.ts#L0-L0).
