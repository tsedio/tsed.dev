---
title: Reason from @tsed/socketio
description: api documentation of Reason from @tsed/socketio
meta:
 - name: keywords
   description: api typescript node.js documentation Reason decorator
---
# Reason - @tsed/socketio
...
> See [/packages/third-parties/socketio/src/decorators/reason.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/third-parties/socketio/src/decorators/reason.ts#L0-L0).
