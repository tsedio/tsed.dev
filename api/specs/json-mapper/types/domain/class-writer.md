---
url: /api/specs/json-mapper/types/domain/class-writer.md
...
> See [/packages/specs/json-mapper/src/domain/Writer.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/json-mapper/src/domain/Writer.ts#L0-L0).
