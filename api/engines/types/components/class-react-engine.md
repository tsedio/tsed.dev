---
url: /api/engines/types/components/class-react-engine.md
...
> See [/packages/engines/src/components/ReactEngine.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/engines/src/components/ReactEngine.ts#L0-L0).
