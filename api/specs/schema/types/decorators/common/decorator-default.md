---
url: /api/specs/schema/types/decorators/common/decorator-default.md
description: api documentation of Default from @tsed/schema
---
...
> See [/packages/specs/schema/src/decorators/common/default.ts](https://github.com/tsedio/tsed/blob/v8.38.4/packages/specs/schema/src/decorators/common/default.ts#L0-L0).

## Overview

```ts
function Default(defaultValue: JSONSchema7Type | undefined | (() => JSONSchema7Type)): (...args: any[]) => any;
```

* **defaultValue** (`JSONSchema7Type` | `undefined` | `(() => JSONSchema7Type)`): - The default value (or function returning the value)
