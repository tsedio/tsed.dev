---
title: SwigEngine from @tsed/engines
...
> See [/packages/engines/src/components/SwigEngine.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/engines/src/components/SwigEngine.ts#L0-L0).
