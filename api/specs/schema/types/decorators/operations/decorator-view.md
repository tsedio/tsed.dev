---
url: /api/specs/schema/types/decorators/operations/decorator-view.md
...
> See [/packages/specs/schema/src/decorators/operations/view.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/decorators/operations/view.ts#L0-L0).
...
and render it using the loaded module’s \_\_express function.
