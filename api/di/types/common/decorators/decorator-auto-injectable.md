---
url: /api/di/types/common/decorators/decorator-auto-injectable.md
...
> See [/packages/di/src/common/decorators/autoInjectable.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/decorators/autoInjectable.ts#L0-L0).
