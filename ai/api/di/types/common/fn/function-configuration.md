...
meta:
 - name: keywords
   description: api typescript node.js documentation configuration function
---
...
> See [/packages/di/src/common/fn/configuration.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/fn/configuration.ts#L0-L0).
