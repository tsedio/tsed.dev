---
title: IgnoreCallback from @tsed/schema
...
> See [/packages/specs/schema/src/domain/IgnoreCallback.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/IgnoreCallback.ts#L0-L0).
