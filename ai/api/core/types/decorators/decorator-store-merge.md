---
title: StoreMerge from @tsed/core
description: api documentation of StoreMerge from @tsed/core
meta:
 - name: keywords
   description: api typescript node.js documentation StoreMerge decorator
---
# StoreMerge - @tsed/core
...
> See [/packages/core/src/decorators/storeMerge.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/core/src/decorators/storeMerge.ts#L0-L0).
