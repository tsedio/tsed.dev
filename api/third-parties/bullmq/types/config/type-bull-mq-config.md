---
url: /api/third-parties/bullmq/types/config/type-bull-mq-config.md
...
> See [/packages/third-parties/bullmq/src/config/config.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/third-parties/bullmq/src/config/config.ts#L0-L0).
