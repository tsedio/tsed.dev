...
> See [/packages/platform/platform-mcp/src/http/services/PlatformMcpModule.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-mcp/src/http/services/PlatformMcpModule.ts#L0-L0).
