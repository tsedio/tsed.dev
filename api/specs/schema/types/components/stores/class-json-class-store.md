---
url: /api/specs/schema/types/components/stores/class-json-class-store.md
...
> See [/packages/specs/schema/src/components/stores/JsonClassStore.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/components/stores/JsonClassStore.ts#L0-L0).
