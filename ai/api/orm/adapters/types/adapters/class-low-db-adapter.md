---
title: LowDbAdapter from @tsed/adapters
description: api documentation of LowDbAdapter from @tsed/adapters
meta:
 - name: keywords
   description: api typescript node.js documentation LowDbAdapter class
---
# LowDbAdapter - @tsed/adapters
...
> See [/packages/orm/adapters/src/adapters/LowDbAdapter.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/orm/adapters/src/adapters/LowDbAdapter.ts#L0-L0).
