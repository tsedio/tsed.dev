...
meta:
 - name: keywords
   description: api typescript node.js documentation uri function
---
# uri - @tsed/schema
...
> See [/packages/specs/schema/src/fn/uri.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/fn/uri.ts#L0-L0).
