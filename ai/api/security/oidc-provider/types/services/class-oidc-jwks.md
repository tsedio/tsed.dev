---
title: OidcJwks from @tsed/oidc-provider
...
> See [/packages/security/oidc-provider/src/services/OidcJwks.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/security/oidc-provider/src/services/OidcJwks.ts#L0-L0).
