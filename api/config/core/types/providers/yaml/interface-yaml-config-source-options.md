...
> See [/packages/config/core/src/providers/yaml/YamlConfigSource.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/config/core/src/providers/yaml/YamlConfigSource.ts#L0-L0).
