---
url: /plugins/premium/config-source/aws-secrets.md
description: >-
  A powerful plugin for Ts.ED to manage your application configuration with AWS
  Secrets manager and sync changes in real time.
---
