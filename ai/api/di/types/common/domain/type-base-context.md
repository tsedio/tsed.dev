---
title: BaseContext from @tsed/di
...
> See [/packages/di/src/common/domain/DIContext.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/domain/DIContext.ts#L0-L0).
