...
meta:
 - name: keywords
   description: api typescript node.js documentation LocalsContainer class
---
...
> See [/packages/di/src/common/domain/LocalsContainer.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/domain/LocalsContainer.ts#L0-L0).
