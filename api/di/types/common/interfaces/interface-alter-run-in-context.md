...
> See [/packages/di/src/common/interfaces/AlterRunInContext.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/interfaces/AlterRunInContext.ts#L0-L0).
