---
title: UseParam from @tsed/platform-params
description: api documentation of UseParam from @tsed/platform-params
meta:
 - name: keywords
   description: api typescript node.js documentation UseParam decorator
---
# UseParam - @tsed/platform-params
...
> See [/packages/platform/platform-params/src/decorators/useParam.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-params/src/decorators/useParam.ts#L0-L0).
