---
url: /api/specs/schema/types/decorators/common/decorator-read-only.md
description: api documentation of ReadOnly from @tsed/schema
---
...
> See [/packages/specs/schema/src/decorators/common/readOnly.ts](https://github.com/tsedio/tsed/blob/v8.38.4/packages/specs/schema/src/decorators/common/readOnly.ts#L0-L0).
...
* **readOnly** (`boolean`): Optional. - Whether the property is read-only (default: true)
