---
title: nullableMapperOpenApi from @tsed/schema
...
> See [/packages/specs/schema/src/components/mappers/open-spec/nullableMapper.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/components/mappers/open-spec/nullableMapper.ts#L0-L0).
