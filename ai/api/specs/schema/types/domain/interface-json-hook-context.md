---
title: JsonHookContext from @tsed/schema
description: api documentation of JsonHookContext from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation JsonHookContext interface
---
# JsonHookContext - @tsed/schema
...
> See [/packages/specs/schema/src/domain/JsonHookContext.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonHookContext.ts#L0-L0).
