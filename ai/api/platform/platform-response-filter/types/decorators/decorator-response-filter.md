...
> See [/packages/platform/platform-response-filter/src/decorators/responseFilter.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-response-filter/src/decorators/responseFilter.ts#L0-L0).
