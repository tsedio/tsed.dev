---
url: /plugins/premium/config-source/postgres.md
description: >-
  A powerful plugin for Ts.ED to manage your application configuration in
  MongoDB and sync changes in real time.
---
