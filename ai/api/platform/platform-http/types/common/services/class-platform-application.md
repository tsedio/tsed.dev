...
> See [/packages/platform/platform-http/src/common/services/PlatformApplication.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/services/PlatformApplication.ts#L0-L0).
