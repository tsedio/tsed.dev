---
url: /api/platform/platform-koa/types/components/class-platform-koa.md
...
> See [/packages/platform/platform-koa/src/components/PlatformKoa.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-koa/src/components/PlatformKoa.ts#L0-L0).
