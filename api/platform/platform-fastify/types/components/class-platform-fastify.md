---
url: /api/platform/platform-fastify/types/components/class-platform-fastify.md
...
> See [/packages/platform/platform-fastify/src/components/PlatformFastify.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-fastify/src/components/PlatformFastify.ts#L0-L0).
