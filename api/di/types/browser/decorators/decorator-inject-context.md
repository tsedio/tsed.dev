...
> See [/packages/di/src/browser/decorators/injectContext.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/browser/decorators/injectContext.ts#L0-L0).
