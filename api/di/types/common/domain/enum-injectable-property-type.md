---
url: /api/di/types/common/domain/enum-injectable-property-type.md
...
> See [/packages/di/src/common/domain/InjectablePropertyType.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/domain/InjectablePropertyType.ts#L0-L0).
