---
url: /api/platform/platform-http/types/testing/class-fake-response.md
...
> See [/packages/platform/platform-http/src/testing/FakeResponse.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/testing/FakeResponse.ts#L0-L0).
