---
url: /api/platform/platform-params/types/decorators/decorator-session.md
...
> See [/packages/platform/platform-params/src/decorators/session.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-params/src/decorators/session.ts#L0-L0).
