---
title: MulterOptions from @tsed/platform-http
description: api documentation of MulterOptions from @tsed/platform-http
meta:
 - name: keywords
   description: api typescript node.js documentation MulterOptions const
---
# MulterOptions - @tsed/platform-http
...
> See [/packages/platform/platform-http/src/common/decorators/multer/multerOptions.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/decorators/multer/multerOptions.ts#L0-L0).
