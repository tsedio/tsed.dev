...
meta:
 - name: keywords
   description: api typescript node.js documentation Hooks class
---
# Hooks - @tsed/hooks
...
> See [/packages/hooks/src/Hooks.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/hooks/src/Hooks.ts#L0-L0).
