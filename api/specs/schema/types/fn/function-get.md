---
url: /api/specs/schema/types/fn/function-get.md
...
> See [/packages/specs/schema/src/fn/from.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/fn/from.ts#L0-L0).
