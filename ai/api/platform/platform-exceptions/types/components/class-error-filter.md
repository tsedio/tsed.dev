...
> See [/packages/platform/platform-exceptions/src/components/ErrorFilter.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-exceptions/src/components/ErrorFilter.ts#L0-L0).
