---
url: /api/di/types/common/decorators/interface-module-options.md
...
> See [/packages/di/src/common/decorators/module.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/decorators/module.ts#L0-L0).
