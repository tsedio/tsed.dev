...
> See [/packages/platform/platform-http/src/common/fn/adapter.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/platform/platform-http/src/common/fn/adapter.ts#L0-L0).
