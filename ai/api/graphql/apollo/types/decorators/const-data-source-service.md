---
title: DataSourceService from @tsed/apollo
description: api documentation of DataSourceService from @tsed/apollo
meta:
 - name: keywords
   description: api typescript node.js documentation DataSourceService const
---
# DataSourceService - @tsed/apollo
...
> See [/packages/graphql/apollo/src/decorators/dataSource.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/graphql/apollo/src/decorators/dataSource.ts#L0-L0).
