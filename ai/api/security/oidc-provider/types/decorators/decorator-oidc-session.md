...
> See [/packages/security/oidc-provider/src/decorators/oidcSession.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/security/oidc-provider/src/decorators/oidcSession.ts#L0-L0).
