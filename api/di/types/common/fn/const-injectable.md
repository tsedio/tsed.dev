---
url: /api/di/types/common/fn/const-injectable.md
...
> See [/packages/di/src/common/fn/injectable.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/di/src/common/fn/injectable.ts#L0-L0).
