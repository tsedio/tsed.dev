...
> See [/packages/security/passport/src/middlewares/PassportMiddleware.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/security/passport/src/middlewares/PassportMiddleware.ts#L0-L0).
