---
url: /docs/configuration/configuration-sources.md
description: >-
  Formerly known as ConfigSource, this module provides a way to load
  configuration from different sources like environment variables, JSON files,
  YAML files,…
---
...
| Type                                                                                   | Watch mode    | Import                              | Description                                                                                                                        |
| -------------------------------------------------------------------------------------- | ------------- | ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [AWS Secrets Manager](https://tsed.dev/plugins/premium/config-source/aws-secrets.html) | Yes - polling | `@tsedio/config-source-aws-secrets` | Load configuration from AWS Secrets Manager.                                                                                       |
