...
> See [/packages/config/core/src/decorators/injectConfigSource.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/config/core/src/decorators/injectConfigSource.ts#L0-L0).
