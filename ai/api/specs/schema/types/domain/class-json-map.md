---
title: JsonMap from @tsed/schema
description: api documentation of JsonMap from @tsed/schema
meta:
 - name: keywords
   description: api typescript node.js documentation JsonMap class
---
# JsonMap - @tsed/schema
...
> See [/packages/specs/schema/src/domain/JsonMap.ts](https://github.com/tsedio/tsed/blob/v8.38.7/packages/specs/schema/src/domain/JsonMap.ts#L0-L0).
